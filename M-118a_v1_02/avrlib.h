...
struct InputOutput {
  ...
  static inline void Write(typename O::Value v) {
    O::Write(v);
  }
  static inline uint8_t writable() {
    return O::writable();
  ...
  static inline void Overwrite(typename O::Value v) {
    O::Overwrite(v);
  }
  static inline typename O::Value Requested() {
    return O::Requested();
  }
  static inline typename I::Value Read() {
    return I::Read();
  }
  static inline uint8_t readable() {
    return I::readable();
